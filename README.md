...
- Normalisation with log-transformation
...
- Visualisation of gene expression levels across treatment groups (Target genes: ACE2, CTSL, TMPRSS2, TMPRSS4, ENO2, TUBB4B, ALDH1A1)
### Trajectory analysis
Pseudotime analysis to identify cell differentiation as the infection progresses.
## Results:
...
*The figures for the other target genes (CTSL, TMPRSS2, and TMPRSS4) can be seen in the Jupyter Notebook (**Single_Cell_Analysis_With_Trajectory.ipynb**)*
...
### Trajectory analysis
Trajectory analysis reveals the differentiation of club cells into ciliated cells, pulmonary alveolar type I cells, goblet cells, and ionocytes throughout all stages of the infection. Club cells have been known to act as stem cells and help regenerate the bronchiolar epithelium in response to damage by differentiating into ciliated cells, goblet cells, and alveolar cells in case of alveolar damage (Zheng et al. 2017; Davis and Wypych 2021). Notably, ciliated cells collected 3 days post-infection (3dpi) exhibit more differentiation from club cells than those collected 2 days post-infection (2dpi), which in themselves exhibit more differentiation than cells after 1dpi. This indicates that SARS-CoV-2 infection leads to damage to the airway epithelium over time, causing differentiation of club cells into ciliated cells as a repair mechanism. However, the differentiation of club cells into ionocytes lacks sufficient evidence and requires further investigation. Club cells and ionocytes have been known to arise from different differentiation paths taken by basal and parabasal stem cells (Cumplido-Laso et al. 2023).
